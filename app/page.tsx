...
export default function LandingPage() {
  ...
  // Track scroll to different sections
  useEffect(() => {
    const handleScroll = () => {
      const scrollPosition = window.scrollY;
      const windowHeight = window.innerHeight;
      
      // Track when user scrolls to features section
      const featuresSection = document.getElementById('features');
      if (featuresSection && scrollPosition >= featuresSection.offsetTop - windowHeight / 2) {
        event({
          action: 'features_section_viewed',
          category: 'landing_page',
          label: 'scroll_engagement'
        });
      }
      
      // Track when user scrolls to how-it-works section
      const howItWorksSection = document.getElementById('how-it-works');
      if (howItWorksSection && scrollPosition >= howItWorksSection.offsetTop - windowHeight / 2) {
        event({
          action: 'how_it_works_section_viewed',
          category: 'landing_page',
          label: 'scroll_engagement'
        });
      }
      ...
      <header className="relative border-b bg-white/80 backdrop-blur-xl sticky top-0 z-50 shadow-sm">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <Link 
              href="#features" 
              className="text-slate-600 hover:text-purple-600 transition-all duration-300 font-medium hover:scale-105"
              onClick={() => {
                event({
                  action: 'features_button_clicked',
                  category: 'landing_page',
                  label: 'navigation'
                });
              }}
            ...
            <Link 
              ...
              onClick={() => {
                event({
                  action: 'how_it_works_button_clicked',
                  category: 'landing_page',
                  label: 'navigation'
                });
              }}
            ...
            <Link 
              href="/login" 
              className="px-4 py-2 text-slate-600 hover:text-purple-600 transition-all duration-300 font-medium hover:bg-purple-50 rounded-lg"
              onClick={() => {
                event({
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            <Link href="/signup">
              <Button
                ...
                onClick={() => {
                  event({
                    action: 'try_for_free_button_clicked',
                    category: 'landing_page',
                    label: 'hero_section'
                  });
                }}
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden border border-white/50">
            ...
            <div className="bg-gradient-to-r from-purple-50 via-blue-50 to-purple-50 p-10 text-center border-t border-purple-200/50">
              ...
              <Link href="/signup">
                <Button 
                  className="group bg-gradient-to-r from-purple-600 via-purple-500 to-blue-600 hover:from-purple-700 hover:via-purple-600 hover:to-blue-700 text-white px-10 py-4 rounded-2xl font-semibold text-lg shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105"
                  onClick={() => {
                    event({
                      action: 'start_free_trial_button_clicked',
                      category: 'landing_page',
